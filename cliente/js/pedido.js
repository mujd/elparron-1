...
function pedidoTamanoDesplegar(oData) { // Despliega los tamaños solicitadas a la API
	...
	$(oData).each(function() {
		if(this.personas <= 24){
			$("#ulTamano").append("<label class='radio'><li class='listado-li'><input type='radio' name='personas' id='" + this.id + "' value='" + this.id + "'>&nbsp;" + this.personas + " Personas</li></label>");
...
// 	if ($('#txtSolicitante').val().trim() === "" || $('#txtTelefono').val().trim() === "") {
// 		var error = 'Debe colocar su nombre y telefono';
// 		var message = 'El siguiente error ocurrio debido a que:\n' + error;
// 		$('#alertModal').find('.modal-body p').text(message)
...
// 	if ($('#datePedido').val().trim() === "") {
// 		var error = 'Debe seleccionar una fecha de retiro';
// 		var message = 'El siguiente error ocurrio debido a que:\n' + error;
// 		$('#alertModal').find('.modal-body p').text(message)
// 		$('#alertModal').modal('toggle')
// 	}else{
...
// 	}
// }
// function validaCmbTorta(){
// 	if ($('#cmbTipoMasa').val().trim() === '' || $('#cmbSaborMasa').val().trim() === '' || $('#cmbSabor').val().trim() === '') {
//         var error = 'Debe seleccionar los ingredientes de la torta';
// 		var message = 'El siguiente error ocurrio debido a que:\n' + error;
// 		$('#alertModal').find('.modal-body p').text(message)
// 		$('#alertModal').modal('toggle')
//     } else {
...
//     }
// }
// function validaCmbSucursal(){
// 	if ($('#cmbSucursalRetiro').val().trim() === '') {
//         alert('Debes seleccionar una Sucursal de retiro');
//     } else {
//         return true;
//     }
// }
...
// 		return true;
//     } else {
// 		alert('Se debe seleccionar el tamaño de la torta');
//     }
// }

//como hacer que no muestre precio(undefined) mientras no se seleccione el tamaño de torta
